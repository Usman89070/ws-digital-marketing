    ...
    <section class="hero" style="padding-bottom: clamp(40px, 8vw, 80px);">
        <div class="container hero-content">
            ...
            <div class="hero-buttons fade-up">
                <a href="contact.php" class="btn-primary">GET MY FREE SEO AUDIT <i class="fa-solid fa-arrow-right" style="margin-left: 5px;"></i></a>
        ...
        <div class="container">
            <div class="agency-grid">
                ...
                <div class="agency-text">
                    ...
                    <a href="contact.php" class="btn-primary" style="margin-top: 10px;">Speak With An SEO Strategist</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="cta-box fade-up">
                ...
                <div class="cta-btn-wrapper">
                    <a href="contact.php" class="btn-primary" style="padding: 18px 45px; font-size: 1.1rem;">GET MY FREE SEO AUDIT <i class="fa-solid fa-arrow-right" style="margin-left: 5px;"></i></a>
                </div>
            </div>
        </div>
    </section>
