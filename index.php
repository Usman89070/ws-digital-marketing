                    ...
                    <div class="dashboard-ui">
                        ...
                        <div class="dash-main">
                            ...
                            <div class="dash-chart-area">
                                ...
                                <span class="dash-chart-label">SEO Ranking Growth Analytics</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mobile-container">
                ...
                <div class="phone-inner">
                    ...
                    <div class="logo-screen">
                        <img src="images/logo-ws.svg" alt="W&S Animated Logo">
        ...
        <div class="container">
            <div class="section-header fade-up" style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: flex-end; text-align: left; gap: 20px; margin-bottom: 20px;">
                ...
                <div style="font-size: 1.1rem; font-weight: bold; display: flex; align-items: center; gap: 10px;">
                    ...
                    <span style="font-weight: 500; font-size: 0.9rem; color: var(--text-muted);">4.9/5 on Google Reviews</span>
                </div>
            </div>
