// Site-wide JS: nav dropdown/toggle, scroll effects, GSAP animations,
// stat counters, split-text reveals, and the Three.js background.
// Loaded once via <script defer>, cached by the browser across every page.
